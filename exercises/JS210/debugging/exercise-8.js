...
/*
The error with the code shown above is the switch statement used on line 44.
For a case in a switch statement to be executed exclusively, a "break" or
"return" statement must be used at the end. However, every case in the code
above lacks such statement. As a result, a value that triggers "case 1", for
instance, will trigger the rest of the cases in the switch statement. 

The solution would be to place a "break" statement at the end of every case.
In turn, every case is executed exclusively from the rest when triggered.
*/